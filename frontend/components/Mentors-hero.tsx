...
export const MentorsHero = () => {
    return (
        <div className="h-[900px] bg-black bg-gradient-to-b from-[#5D2CA8] to-balck text-white py-[72px] flex items-center justify-center sm:py-24">
        <div className="container">
            <h2 className="text-center font-bold text-5xl sm:text-6xl tracking-tighter">Meet Our Guiders</h2>
